...
- بۆتێکی تەلگرام بۆ پەخشکردنی ڕادیۆ/مۆسیقا لە کەنال یان گروپی دەنگ چات.
- بۆتی تێلیگرام بۆ پەخشکردنی دەنگ لە دەنگی چات لەگەڵ یوتوب و پشتگیری دیزەر.
- پشتگیری لە جۆشدانی ڕاستەوخۆ دەکات لە یوتیوبەوە.

---

## NOTE:

- دڵنیابە لەوەی کە دەستت کردووە بە VoiceChat لە گروپەکەت پێش بڵاو کردنەوە.
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/bnyaminali/vcplay">
...
```sh
git clone https://github.com/bnyaminali/vcplay
cd VCMusicPlayer
